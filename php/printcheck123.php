...
$query.= "CONCAT(b.nombre, ' / ', c.nommoneda, ' / ', b.nocuenta, ' / Cheque No. ', a.numero, ' / ', d.abreviatura) AS banco, d.nomempresa AS empresa ";
...
$pdf->Ln(0.3 * $conv);
$pdf->Cell(3 * $conv);
$pdf->Cell(11.5 * $conv, 0.65 * $conv, $n2l->to_word_int($cheque->monto), $borde, 0);
$pdf->Ln(1.3 * $conv);
...
$pdf->Ln(4 * $conv);
$pdf->Cell(1.55 * $conv);
$pdf->MultiCell(10 * $conv, 0.45 * $conv, iconv('UTF-8', 'windows-1252', $cheque->concepto), $borde, 'L');
